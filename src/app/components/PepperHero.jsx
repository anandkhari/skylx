      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-12 w-full">
        ...
        >
          ...
          <p className="text-white/70 text-sm font-light leading-relaxed max-w-md mb-10">
            GI-certified Malabar and Tellicherry black pepper sourced direct from the Western Ghats —
            density-graded, piperine-verified, and cleared to global export standards.
          </p>
          <Link
            href="/contact"
