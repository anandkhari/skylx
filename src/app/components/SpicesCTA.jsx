...
const ctaTransition = { duration: 1, ease: [0.16, 1, 0.3, 1] };
    ...
    <section className="py-32 bg-[#0D1B4B]">
      <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
        ...
        >
          ...
          <div className="w-12 h-px bg-[#1A6FD4] mx-auto mb-8 opacity-60" />
          ...
          <Link
            href="/contact"
            className="inline-block text-xs text-white uppercase tracking-[0.15em] font-bold border border-[#1A6FD4] px-8 py-4 hover:bg-[#1A6FD4] rounded-lg transition-colors duration-300"
          >
            Contact Us
          </Link>
        </motion.div>
