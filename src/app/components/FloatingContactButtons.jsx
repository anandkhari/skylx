          ...
          <div key={action.label} className="group relative pointer-events-auto">
            ...
            <a
              ...
              {...(action.external
                ...
                : {})}
              className={`flex h-12 w-12 items-center justify-center rounded-full text-white shadow-[0_18px_38px_rgba(13,27,75,0.18)] transition-all duration-300 hover:-translate-y-1 hover:scale-[1.03] focus-visible:outline-none focus-visible:ring-4 ${action.backgroundClass} ${action.ringClass} sm:h-13 sm:w-13`}
            >
