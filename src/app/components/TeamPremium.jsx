      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12">
        ...
        <div className="mb-20 text-center">
          ...
          <p className="text-sm text-gray-500 max-w-2xl mx-auto font-light leading-relaxed">
            Our leadership team draws from decades of multinational supply chain
            experience, engineering the definitive infrastructure for global
            trade.
          </p>
        </div>
